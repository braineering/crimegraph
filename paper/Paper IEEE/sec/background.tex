...
Given two vertices $x,y \in V$, we denote with $\Gamma(x)$ the set of neighbours of $x$ (i.e. adjacent vertices) and with $\Gamma(x,y) = \Gamma(x) \bigcap \Gamma(y)$ the set of common neighbours between $x$ and $y$.
