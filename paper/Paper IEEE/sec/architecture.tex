...
% aDSP is a computational paradigm in which the sources emit continuous data \textit{streams}, which are then processed in real-time by distributed and parallel operators.
